...
class SheetFormulasController extends Controller
{
 public function handle(Request $request, $id = null)
    ...
    {
        $units = SheetFormulas::all();
        return response()->json($units);
    }
    private function getRowUnit($id)
    {
        $unit = SheetFormulas::find($id);
    ...
    private function update(Request $request)
    {
        ...
        $unit = SheetFormulas::find($request->id);
        $unit->update([
            'Name' => $request->Name,
            'NameRus' => $request->NameRus,
            'ShortName' => $request->ShortName,
    ...
    {
        try {
            $unit = SheetFormulas::findOrFail($id);
            $unit->delete();
